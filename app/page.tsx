...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="listings-section" id="listings">
        <div className="container">
          ...
          <div className="listings-grid">
            {[
              { price: "35,000", unit: "/ month", title: "3 Bedroom House with Car Porch", area: "North Karachi · Sector 11-B", specs: ["3 Beds", "2 Baths", "120 Sq Yd"], type: "rent" },
              { price: "1.2 Crore", unit: "", title: "Corner 240 Sq Yd Plot", area: "Surjani Town · Sector 7-A", specs: ["240 Sq Yd", "Corner", "Residential"], type: "sale" },
              { price: "22,000", unit: "/ month", title: "2 Bed Apartment – 1st Floor", area: "North Nazimabad · Block H", specs: ["2 Beds", "2 Baths", "900 Sqft"], type: "rent" },
              { price: "85 Lakh", unit: "", title: "4 Bedroom Bungalow – Ready to Move", area: "New Karachi · Sector 5-L", specs: ["4 Beds", "3 Baths", "120 Sq Yd"], type: "sale" },
              { price: "18,000", unit: "/ month", title: "Commercial Shop – Ground Floor", area: "Bufferzone · Sector 15", specs: ["200 Sqft", "Main Road", "Commercial"], type: "rent" },
              { price: "1.6 Crore", unit: "", title: "Double Storey House – Renovated", area: "Nazimabad · Block 3", specs: ["5 Beds", "4 Baths", "200 Sq Yd"], type: "sale" },
            ].map((listing, i) => (
                ...
                <div className="listing-img">
                  <div className="listing-img-placeholder">
                    <svg width="60" height="60" fill="none" viewBox="0 0 60 60">
                      <path d="M8 52V28L30 8l22 20v24H8z" stroke="#aab4c4" strokeWidth="1.5" fill="#c8d0dc" />
                      <rect x="22" y="34" width="16" height="18" rx="1" fill="#aab4c4" />
                    </svg>
                  </div>
      ...
      <footer>
        <div className="footer-top">
          <div className="footer-brand">
            <span className="footer-logo">Aashiyana <em>Associates</em></span>
      ...
      {/* WhatsApp Float */}
      <a href="https://wa.me/923443544381" className="wa-float" target="_blank" rel="noreferrer" aria-label="Chat on WhatsApp">
