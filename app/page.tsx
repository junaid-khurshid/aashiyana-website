...
const agents = [
  { name: "Syed Muhammad Khurshid Alam", role: "CEO", phones: ["0333-2287377", "0315-2400381"] },
  { name: "Masood Azhar", role: "", phones: ["0333-2294241", "0311-2951385"] },
  { name: "Muhammad Kamal", role: "", phones: ["0335-3285003", "0316-2153274"] },
  { name: "Abdul Wahid", role: "", phones: ["0302-0252102", "0316-2802504"] },
  { name: "Mansoor Ahmed", role: "", phones: ["0334-9489482", "0313-9489482"] },
  { name: "Ather Khan", role: "", phones: ["0300-2473927"] },
];
    ...
    <>
      ...
      <section className="agents-section" id="agents">
        <div className="container">
          <div className="section-header centered">
            <div className="section-eyebrow" style={{ justifyContent: "center" }}>
              <span></span><p>Our Team</p><span></span>
            </div>
            <h2>Meet Our Agents</h2>
            <p>Experienced professionals ready to help you buy, sell or rent property in Karachi</p>
          </div>
          <div className="agents-grid">
            {agents.map((agent, i) => (
              <div className="agent-card" key={i}>
                ...
                <div className="agent-phones">
                  {agent.phones.map((phone: string) => (
                    <a
                      key={phone}
                      href={`https://wa.me/92${phone.replace(/^0/, "").replace(/-/g, "")}`}
                      target="_blank"
                      rel="noreferrer"
